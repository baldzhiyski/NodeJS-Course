...
exports.getToursStats = async (req, res) => {
  try {
    ...
    // If any error occurs during the aggregation or processing, it is caught here.
    // handleError is a helper function to handle and send error responses.
    handleError(res, error);
  }
};
...
exports.getMontlyPlan = async (req, res) => {
  try {
    ...
    // If any error occurs during the aggregation, it is caught here.
    // handleError is a helper function to handle and send error responses.
    handleError(res, error);
  }
};
