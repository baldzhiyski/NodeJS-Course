      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Logged in successfilly!');
        ...
        case 8:
          ...
          if (_context.t0.response && _context.t0.response.data.message.includes('Invalid token')) {
            (0, _alert.showAlert)('error', 'Session expired. Redirecting to home page...');
            setTimeout(function () {
      ...
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          if (res.status === 200) {
            ...
            (0, _alert.showAlert)('error', "Error: ".concat(res.data.message));
          }
          _context2.next = 10;
          break;
        case 7:
          _context2.prev = 7;
          _context2.t0 = _context2["catch"](0);
          (0, _alert.showAlert)('error', ((_err$response = _context2.t0.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || 'Something went wrong.');
        case 10:
        case "end":
          return _context2.stop();
      }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Booking was successful!');
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          (0, _alert.showAlert)('error', 'This tour is already booked !');
        case 11:
        case "end":
          return _context.stop();
      }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"markFavourite.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
function toggleFavorite(_x) {
  return _toggleFavorite.apply(this, arguments);
}
function _toggleFavorite() {
  _toggleFavorite = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(button) {
    var tourId, isActive, response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          tourId = button.dataset.tourId;
          isActive = button.classList.contains('active'); // Check if the button is currently active
          _context.prev = 2;
          _context.next = 5;
          return (0, _axios.default)({
            method: 'POST',
            ...
            // Correctly send data using 'data'
            headers: {
        ...
        case 5:
          ...
          if (response.data.status === 'success') {
            ...
            (0, _alert.showAlert)('success', response.data.message); // Show success alert
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
        ...
        case 9:
          ...
          (0, _alert.showAlert)('error', _context.t0.message); // Handle errors properly
        case 12:
        case "end":
          return _context.stop();
      }
...
var _markFavourite = require("../js/markFavourite");
...
var favoritesToggle = document.getElementById('favorites-dropdown-toggle');
var dropdownMenu = document.getElementById('favorites-dropdown');
favoriteButtons.forEach(function (button) {
  button.addEventListener('click', function () {
    return (0, _markFavourite.toggleFavorite)(button);
  });
});
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    var email = document.getElementById('email').value;
    var _document$getElementB = document.getElementById('name').value.split(' '),
      _document$getElementB2 = _slicedToArray(_document$getElementB, 2),
      firstName = _document$getElementB2[0],
      lastName = _document$getElementB2[1];
...
if (resetPassButton) {
  resetPassButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var email;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
        ...
        case 4:
          _context2.next = 6;
          return (0, _updateSettings.resetPassword)(email);
        case 6:
        case "end":
          return _context2.stop();
      }
